...
# MAGIC %sql
# MAGIC
# MAGIC DROP table hive_metastore.demo_dlt_integrals.raw;
# MAGIC
# MAGIC DROP table hive_metastore.demo_dlt_integrals.input_table;
# MAGIC
# MAGIC DROP table hive_metastore.demo_dlt_integrals.dlt_integrals
...
# MAGIC
# MAGIC truncate table hive_metastore.demo_dlt_integrals.input_table;
# MAGIC
# MAGIC truncate table hive_metastore.demo_dlt_integrals.dlt_integrals

# COMMAND ----------

spark.sql("insert into hive_metastore.demo_dlt_integrals.raw values('L1', 'Wind_Speed', date_trunc('minute', current_timestamp()), 30.0)")
...
input_batch = spark.sql(f"""
    ...
    FROM (
      VALUES
      -- Key Group 1
      ("L1", "Wind_Speed", date_trunc('minute', current_timestamp()), 30.0) --,
      ("L1", "Wind_Speed", timestampadd(minute, 10, date_trunc('minute', current_timestamp())), 40.0)
    );  
  """)
display(input_batch)
